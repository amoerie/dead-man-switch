...
namespace DeadManSwitch
{
    ...
    {
        /// <summary>
        /// Notifies the dead man's switch, postponing the cancellation of the <see cref="IDeadManSwitchWorker{TResult}"/> task
        /// </summary>
        /// <param name="notification">
        /// A notification message that will be shown when the worker task is cancelled.
        /// This can be useful to retrace the last steps of the worker task.
        /// </param>
        ...
        /// <summary>
        /// Pauses the dead man's switch. The worker task cannot be cancelled until the dead man's switch is resumed.
        /// </summary>
    ...
    internal sealed class DeadManSwitch : IDeadManSwitch
    {
